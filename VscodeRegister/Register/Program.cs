...
namespace NodeRegister
{
    ...
    class SysEnvironment
    {
        ...
        public static RegistryKey registVSCode(string path)
        {
            RegistryKey regLocalMachine = Registry.ClassesRoot;
            RegistryKey regDirectory = regLocalMachine.OpenSubKey("Directory", true);
            RegistryKey regBackground = regDirectory.OpenSubKey("Background", true);
            RegistryKey regshell = regBackground.OpenSubKey("shell", true);

            // 新建VSCode/command
            regshell.CreateSubKey("VSCode", true).CreateSubKey("command");

            RegistryKey regVSCode = regshell.OpenSubKey("VSCode", true);
            RegistryKey regcommand = regVSCode.OpenSubKey("command", true);

            //[HKEY_CLASSES_ROOT\Directory\Background\shell\VSCode]
            // @="Open VSCode Here"
            // "Icon"="G:\\MidwayCommandCenter\\SEAL\\VSCode-win32-x64-1.51.1\\Code.exe"
            regVSCode.SetValue("", "Open VSCode Here");
            regVSCode.SetValue("Icon", path);

            // [HKEY_CLASSES_ROOT\Directory\Background\shell\VSCode\command]
            // @="G:\\MidwayCommandCenter\\SEAL\\VSCode-win32-x64-1.51.1\\Code.exe ."            
            regcommand.SetValue("", path + @" .");

            //======================================================================================================
            RegistryKey regshell2 = regDirectory.OpenSubKey("shell", true);

            // 新建VSCode/command
            regshell2.CreateSubKey("VSCode", true).CreateSubKey("command");

            RegistryKey regVSCode2 = regshell2.OpenSubKey("VSCode", true);
            RegistryKey regcommand2 = regVSCode2.OpenSubKey("command", true);

            //[HKEY_CLASSES_ROOT\Directory\shell\VSCode]
            //@="Open VSCode Here"
            //"Icon"="G:\\MidwayCommandCenter\\SEAL\\VSCode-win32-x64-1.51.1\\Code.exe"
            regVSCode2.SetValue("", "Open VSCode Here");
            regVSCode2.SetValue("Icon", path);

            //[HKEY_CLASSES_ROOT\Directory\shell\VSCode\command]
            //@="G:\\MidwayCommandCenter\\SEAL\\VSCode-win32-x64-1.51.1\\Code.exe %1"     
            regcommand2.SetValue("", path + @" %1");
